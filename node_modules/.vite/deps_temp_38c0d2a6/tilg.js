import {
  __commonJS,
  require_react
} from "./chunk-E5Z66IA4.js";

// .yarn/__virtual__/tilg-virtual-13264444c8/4/AppData/Local/Yarn/Berry/cache/tilg-npm-0.1.1-38cfabd256-10c0.zip/node_modules/tilg/dist/development.js
var require_development = __commonJS({
  ".yarn/__virtual__/tilg-virtual-13264444c8/4/AppData/Local/Yarn/Berry/cache/tilg-npm-0.1.1-38cfabd256-10c0.zip/node_modules/tilg/dist/development.js"(exports, module) {
    ...
    function md(strings, args = [], hints = {}, trace = "") {
      ...
      const result = [];
      const styles = [];
      function process2(type, open, close, next, prev) {
      ...
      for (let i = 0; i < strings.length; i++) {
        ...
        for (let j = 0; j < str.length; j++) {
          ...
          if (char === "*") {
            if (str[j + 1] === "*") {
              j++;
              process2("**", IS_BROWSER ? "font-weight: bold;" : "\x1B[1m", IS_BROWSER ? "font-weight: normal;" : "\x1B[22m", str[j + 1], prev);
            } else {
              process2("*", IS_BROWSER ? "font-style: italic;" : "\x1B[3m", IS_BROWSER ? "font-style: normal;" : "\x1B[23m", str[j + 1], prev);
            }
          } else if (char === "_") {
            if (str[j + 1] === "_") {
              j++;
              process2("__", IS_BROWSER ? "font-weight: bold;" : "\x1B[1m", IS_BROWSER ? "font-weight: normal;" : "\x1B[22m", str[j + 1], prev);
            } else {
              process2("_", IS_BROWSER ? "font-style: italic;" : "\x1B[3m", IS_BROWSER ? "font-style: normal;" : "\x1B[23m", str[j + 1], prev);
            }
          } else if (char === "`") {
            process2("`", IS_BROWSER ? "background: hsla(0,0%,70%,.3); border-radius:3px; padding: 0 2px;" : "\x1B[96m\x1B[1m", IS_BROWSER ? "background: unset;" : "\x1B[39m\x1B[22m", str[j + 1], prev);
          }
          prev = char;
        ...
        if (disableStyling) {
          ...
          if (hasNextSlot && hints[i]) {
            process2("~", IS_BROWSER ? "text-decoration: underline; text-decoration-color: green; text-decoration-style: wavy; padding-bottom: 1px; text-decoration-skip-ink: none;" : "", "");
          }
          if (formatted !== "") {
            if (result.length) {
          ...
          if (hasNextSlot && hints[i]) {
            formatted = "";
            process2("~", IS_BROWSER ? "text-decoration: none; padding-bottom: 0;" : "", "");
            result[result.length - 1] += formatted;
          }
        }
      }
...
// .yarn/__virtual__/tilg-virtual-13264444c8/4/AppData/Local/Yarn/Berry/cache/tilg-npm-0.1.1-38cfabd256-10c0.zip/node_modules/tilg/index.js
var require_tilg = __commonJS({
  ".yarn/__virtual__/tilg-virtual-13264444c8/4/AppData/Local/Yarn/Berry/cache/tilg-npm-0.1.1-38cfabd256-10c0.zip/node_modules/tilg/index.js"(exports, module) {
    if (false) {
      module.exports = null;
    } else {
...
export default require_tilg();
//# sourceMappingURL=tilg.js.map
